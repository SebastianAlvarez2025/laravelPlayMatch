<?php $__env->startSection('title', 'cronologia'); ?>
...
<div class="container-sm d-flex justify-content-center mt-5">
    <div class="card" style="width: 1200px;">
        <div class="card-body">
            ...
            <form action="<?php echo e(url('/cronologia')); ?>" method="GET">
                ...
                <div class="row g-2 align-items-center">
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="search" value="<?php echo e(request('search')); ?>" placeholder="Buscar por Id, Nombre o Gravedad ">
                        </div>
                    </div>
                    <div class="col-md-6 text-end">
                        <button type="submit" class="btn btn-info"><i class="fas fa-search-plus"></i> Buscar</button>
                        <a href="<?php echo e(url('/cronologia')); ?>" class="btn btn-warning"><i class="fas fa-list"></i> Reset</a>
                    </div>
                </div>
            </form>
            ...
            <?php if($datos->count() > 0): ?>
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <?php $__currentLoopData = $datos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($item->id_cronologia); ?></td>
                                <td><?php echo e($item->id_jugador); ?></td>
                                <td><?php echo e($item->estado); ?></td>
                                <td><?php echo e($item->minuto); ?></td>
                                <td><?php echo e($item->tipo_evento); ?></td>
                                <td><?php echo e($item->descripcion); ?></td>
                                <td><?php echo e($item->tarjeta); ?></td>
                                <td><?php echo e($item->id_encuentro); ?></td>
                            <td>
                                <!-- BOTÓN EDITAR -->
                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editarModal<?php echo e($item->id_cronologia); ?>">
                                    <i class="fa-solid fa-pen-to-square"></i> Editar
                                </button>

                                <!-- BOTÓN ELIMINAR -->
                                <form action="<?php echo e(route('cronologia.destroy', $item->id_cronologia)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                        ...
                        <!-- MODAL EDITAR -->
                        <div class="modal fade" id="editarModal<?php echo e($item->id_cronologia); ?>" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form action="<?php echo e(route('cronologia.update', $item->id_cronologia)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="id_jugador" value="<?php echo e($item->id_jugador); ?>" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="estado" class="form-label">Estado</label>
                                                <input type="text" class="form-control" name="estado" value="<?php echo e($item->estado); ?>" required>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="tipo_evento" value="<?php echo e($item->tipo_evento); ?>" required>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" name="id_encuentro" value="<?php echo e($item->id_encuentro); ?>" required>
                                            </div>
                                        </div>
        ...
        <div class="modal fade" id="agregarModal" tabindex="-1" aria-labelledby="agregarModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="<?php echo e(route('cronologia.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="modal-header">
...
<?php echo $__env->make('welcome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelPlayMatch\resources\views/cronologia.blade.php ENDPATH**/ ?>